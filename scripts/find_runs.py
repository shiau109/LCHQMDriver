"""Find saved measurement runs — the "where is my data" script.

    python scripts/find_runs.py                                    # latest runs
    python scripts/find_runs.py --experiment qubit_ramsey --qubit q1
    python scripts/find_runs.py --tag cooldown7 --since 2026-07-01
    python scripts/find_runs.py --show 20260704-153012-qubit_ramsey-01   # full record
