...
from customized.node.LCH_CZ_conditional_phase import (
    Parameters,
    fit_raw_data,
    log_fitted_results,
...
def create_qua_program(node: QualibrationNode[Parameters, Quam]):
    ...
    readout_angle_array = np.linspace(-1.0, 1.0, node.parameters.readout_angle_point)  # Readout basis index (0 or 1)
        ...
        for multiplexed_qubits in qubits.batch():
            ...
            with for_(n, 0, n < n_avg, n + 1):
                ...
                with for_each_(c_sw, ctrl_switch):
                    with for_(*from_array(roa,readout_angle_array/2) ):
                        ...
                        qubit_sweep.xy.frame_rotation_2pi(0.5)
