...
flow while the visualization (overlay of the reset off/on curves) is produced by
`plotting.plot_reset_check`. A real fit (e.g. a residual-population pass/fail metric) can be
dropped in here later without touching the probe or the shell.
"""
