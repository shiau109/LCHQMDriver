...
class NodeSpecificParameters(RunnableParameters):
    ...
    """Idle gap (ns, multiple of 4) inserted between the circuit's gate operations on the flux
    lines (after the initial reset and each swap), so a preceding flux pulse can settle before
    the narrow swap resonance. Default 0."""
