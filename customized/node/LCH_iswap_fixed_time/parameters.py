...
class NodeSpecificParameters(RunnableParameters):
    ...
    ctrl_amp_max: float = 0.1
    ctrl_amp_min: float = -0.1
    ctrl_amp_step: float = 0.003
    cplr_amp_max: float = 0.1
    cplr_amp_min: float = -0.1
    cplr_amp_step: float = 0.003
    use_state_discrimination: bool = True
    update_all_pulses: bool = True
    operation: Literal["iswap_bare"] = "iswap_bare"
